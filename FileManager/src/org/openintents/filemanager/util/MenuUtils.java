...
public abstract class MenuUtils extends ListActivity {
	...
	public static boolean handleMultipleSelectionAction(
		...
		if (mItem.getItemId() == R.id.menu_send) {
		...
		} else if (mItem.getItemId() == R.id.menu_delete) {
		...
		} else if (mItem.getItemId() == R.id.menu_move) {
			...
			if (VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB)
				ActionbarRefreshHelper.activity_invalidateOptionsMenu(navigator
						.getActivity());
		} else if (mItem.getItemId() == R.id.menu_copy) {
			((FileManagerApplication) navigator.getActivity().getApplication())
			...
			if (VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB)
				ActionbarRefreshHelper.activity_invalidateOptionsMenu(navigator
						.getActivity());
		} else if (mItem.getItemId() == R.id.menu_compress) {
		...
		} else if (mItem.getItemId() == R.id.menu_moveaction) {
	...
	public static boolean handleSingleSelectionAction(
		...
		DialogFragment dialog;
		Bundle args;
		if (mItem.getItemId() == R.id.menu_open) {
			navigator.openInformingPathBar(fItem);
			return true;
		} else if (mItem.getItemId() == R.id.menu_create_shortcut) {
			...
			return true;
		} else if (mItem.getItemId() == R.id.menu_rename) {
			...
			return true;
		} else if (mItem.getItemId() == R.id.menu_send) {
			sendFile(fItem, context);
			return true;
		} else if (mItem.getItemId() == R.id.menu_details) {
			...
			return true;
		} else if (mItem.getItemId() == R.id.menu_extract) {
			...
			return true;
		} else if (mItem.getItemId() == R.id.menu_bookmark) {
			...
			query.close();
			return true;
		} else if (mItem.getItemId() == R.id.menu_more) {
